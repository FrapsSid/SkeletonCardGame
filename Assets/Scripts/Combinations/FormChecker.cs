...
{
    /// <summary>
    /// —татические утилиты дл€ проверки формы комбинации (без учета источников)
    /// </summary>
    public static class FormChecker
    {
        /// <summary>
        /// ѕровер€ет, что карты образуют последовательность рангов
        /// </summary>
        ...
        /// <summary>
        /// ѕровер€ет, что карты образуют последовательность рангов одной масти
        /// </summary>
        ...
        /// <summary>
        /// ѕровер€ет, что все карты одной масти
        /// </summary>
        ...
        /// <summary>
        /// ѕровер€ет, что карты образуют группы рангов с заданными размерами
        /// Ќапример, [3, 2] дл€ фулла (тройка + пара)
        /// </summary>
        ...
        /// <summary>
        /// ѕровер€ет, что есть N карт одного ранга
        /// </summary>
        ...
        /// <summary>
        /// ѕровер€ет, что карты образуют N пар последовательных рангов
        /// </summary>
        public static bool IsConsecutivePairs(List<CardData> cards, int pairCount)
        {
            ...
            // ѕровер€ем, что ранги идут подр€д
        ...
        /// <summary>
        /// ѕровер€ет, что карты - это две пары (не об€зательно последовательных рангов)
        /// </summary>
        ...
        /// <summary>
        /// ѕровер€ет форму "–азводной ћост": две последовательности по 3 карты с пропуском 1 ранга
        /// ѕример: 4-5-6 и 8-9-10
        /// </summary>
        public static bool IsBridgeForm(List<CardData> cards)
        {
            ...
            // ѕровер€ем, что есть две последовательности по 3 карты
