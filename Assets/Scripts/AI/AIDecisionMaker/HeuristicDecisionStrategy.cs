...
public class HeuristicDecisionStrategy : BaseAIDecisionStrategy
{
    ...
    public override AIResponsePackage ChooseBettingAction(GameStateSnapshot snapshot)
    {
        ...
        {
            List<BodyPart> partsToCall = stakeEvaluator.SelectBodypartsForTradeAction(risk, snapshot.OwnBody, snapshot.CurrentParticipationPrice);
        ...
        {
            List<BodyPart> partsToRaise = stakeEvaluator.SelectBodypartsForTradeAction(risk, snapshot.OwnBody);
